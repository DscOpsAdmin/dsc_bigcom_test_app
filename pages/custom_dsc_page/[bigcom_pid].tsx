...
const BigCommerceProductInfo = (props) => {
    ...
    try{
        ...
        //     customerId: "11",
        //     productId: "93",
        //     todayDate: "12-21-2022"
        // };

        const handleBackClick = () => {
            const logTitle = " handleBackClick() ";
            try{
                router.push("/custom_dsc_page/");
            }catch(e){
        ...
        return (
            <Panel>
                ...
                <StyledBox className='boxStyle' border="box">
